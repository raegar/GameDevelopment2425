...
public class TestViking : MonoBehaviour
{
    ...
    private void Start()
    {
        vikingName = NamingManager.Instance.GetFullNameQuickly(gender, isChild, usePatronymics, fatherName); // <--- The method called here provides complete functionality for getting a full name.
