...
namespace Vikings
{
    ...
    public class VikingBaseStats : ScriptableObject
    {
        ...
        public int ageInDays = 1;  // average life expectancy of a Viking was 35-40 years (but death by old age has not been discussed)
        ...
        [Header("Money Owned"), Tooltip("The personal wealth of the settler")]
